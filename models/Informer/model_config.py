"""Model-specific configuration for Informer."""
...
@dataclass
class InformerConfig(BaseExpConfig):
    ...
    distil: bool = field(default=False, metadata={'help': 'whether to use distilling in encoder, using this argument means not using distilling', 'prefix': 'distil', 'order': 105})
