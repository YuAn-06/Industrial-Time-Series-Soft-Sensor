...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if self.task == 'soft_sensor':
            ...
            self.projection = nn.Sequential(
                ...
                nn.Linear(configs.C_in, configs.C_out, bias=True),
            )
    ...
    def soft_sensor(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        enc_out = enc_out[-1] # select last layer feature [B, C, seg_num, d_model] 


        enc_out = self.flatten(enc_out.permute(0, 1, 3, 2))
