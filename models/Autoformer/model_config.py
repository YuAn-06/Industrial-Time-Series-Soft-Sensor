"""Model-specific configuration for Autoformer."""
...
@dataclass
class AutoformerConfig(BaseExpConfig):
    ...
    moving_avg: int = field(default=25, metadata={'help': 'moving average for Autoformer', 'prefix': 'ma', 'order': 105})
