...
def Init_parser():
    ...
    parser.add_argument('--task', type=str, default='short_term_forecasting',
                        help="Task type: ['short_term_forecasting', 'soft_sensor']")
    ...
    parser.add_argument('--use_condition_label', action='store_true',
                        help='If use mode variable for multi_mode dataset')
    ...
    parser.add_argument('--pd_model', type=int, default=32, help='patch embedding dimension after encoder')
    ...
    parser.add_argument('--lradj', type=str, default='cosine',
                        help="Learning rate adjustment strategy: ['type1', 'type2', 'cosine']")
    ...
    parser.add_argument('--output_type', type=str, default='mean', help='Output type for CVAESMC',
                        choices=['mean', 'median', 'sample'])
    ...
    parser.add_argument('--DMVAER_loss_weight', type=list, default=[0.1, 1, 1, 1, 0.01],
                        help='0: x reconstruction, 1: y reconstruction, 2: KL_zt, 3: KL_zs, 4: KL_C')

    # Nonstationary Transformer
    parser.add_argument('--p_hidden_dims', type=list, default=[128, 128],
                        help='Hidden dimensions for projection network')
    ...
    # TimesMixer & SOFTS
    parser.add_argument('--down_sampling_window', type=int, default=4,
                        help='Down sampling window for TimesMixer and TimeKAN ')
    ...
    parser.add_argument('--down_sampling_layers', type=int, default=2,
                        help='Number of down sampling layers for TimesMixer')
    ...
    parser.add_argument('--mode_select', type=str, default='random',
                        help='Mode selection method for FEDformer: [random, low]')
...
def Parse_arguments(yaml_path=None):
    ...
    selected_keys = ["data_name", "model", "task", "seq_len", "label_len", "pred_len", "dropout", "activation",
                     "batch_size", "learning_rate", "epoch", "d_model", "d_ff", "hidden_dim", "patience"]
